...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.west = function () {
        this.p = false;
    };
    AppComponent.prototype.gest = function () {
        this.p = !this.p;
        if (this.p) {
            this.buttonname = "hide";
        }
...
var routes = [{ path: "", component: _raj_raj_component__WEBPACK_IMPORTED_MODULE_3__["RajComponent"],
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.test = function (v) {
        if (v.name === "users") {
...
var RajComponent = /** @class */ (function () {
    function RajComponent() {
    }
    RajComponent.prototype.ngOnInit = function () {
    };
...
var SrComponent = /** @class */ (function () {
    ...
    SrComponent.prototype.close = function (k) {
        this.ev.emit(k);
...
var routes = [{ path: 'users', component: _users_users_component__WEBPACK_IMPORTED_MODULE_3__["UsersComponent"] }];
